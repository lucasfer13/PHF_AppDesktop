...
Public Class InformacionGuarderia
    ...
    Private Sub InformacionGuarderia_Closing(sender As Object, e As CancelEventArgs)
    ...
    Private Sub btnInformacioGuarderiaEnrere_Click(sender As Object, e As EventArgs)
        Me.Close()
    End Sub

    Private Sub btnInformacioGuarderiaGuardar_Click(sender As Object, e As EventArgs)
        contError = 0
        Me.ValidateChildren()
        If contError = 0 Then
            If guarderia Is Nothing Then
    ...
    Private Sub txtInformacioGuarderia_Validating(sender As TextBox, e As CancelEventArgs)
    ...
    Private Sub InformacionGuarderia_Load(sender As Object, e As EventArgs)
        If guarderia Is Nothing Then
            setModify()
            btnInformacioGuarderiaAfegirVacances.Enabled = False
            btnInformacioGuarderiaEliminarVacances.Enabled = False
    ...
    Private Sub btnInformacioGuarderiaPais_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnInformacioGuarderiaMunicipi_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnInformacioGuarderiaAfegirServei_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnInformacioGuarderiaAfegirVacances_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnInformacioGuarderiaEliminarVacances_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnInformacioGuarderiaEliminarServei_Click(sender As Object, e As EventArgs)
